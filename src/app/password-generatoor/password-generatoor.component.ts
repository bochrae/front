...
@Component({
  selector: 'app-password-generatoor',
  templateUrl: './password-generatoor.component.html',
  styleUrls: ['./password-generatoor.component.css']
})
export class PasswordGeneratoorComponent {
  password = ''
  passwordLength = 0
